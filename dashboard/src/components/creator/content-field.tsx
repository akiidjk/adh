    ...
    <FormField
      ...
      render={({ field }) => (
        <FormItem>
            ...
            <TabsContent value='code' className='mt-4'>
              ...
              <FormControl>
                <CodeEditor
                  language={language}
                  value={field.value || ''}
                  onChange={(value) => form.setValue('body', value, { shouldValidate: true })}
                  onSave={(latestValue) => {
                ...
                {uploadedFile ? (
                  <div className='flex flex-col items-center gap-3'>
                    <div className='flex size-16 items-center justify-center rounded-full bg-accent/20'>
                      <FileCode className='size-8 text-accent' aria-hidden='true' />
                    </div>
                  ...
                  <>
                    ...
                    <div className='text-center'>
                      ...
                      <p className='mt-1 text-xs text-muted-foreground opacity-70'>.js, .html, .css, .json (max 5MB)</p>
                    </div>
                  </>
                )}
              </div>
              ...
              {uploadedFile && body && (
                <div className='mt-4 space-y-2'>
                  <div className='flex items-center justify-between text-sm text-muted-foreground'>
                    ...
                    <Badge variant='secondary'>{body.split('\n').length} lines</Badge>
                  </div>
          ...
          <FormDescription>Enter the code directly or upload a file</FormDescription>
