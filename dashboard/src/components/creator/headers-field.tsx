...
export function HeadersField({ form, headerFields, onAppend, onRemove }: HeadersFieldProps) {
  return (
    <FormItem>
            ...
            <Tooltip>
              ...
              <TooltipContent side='right' className='max-w-xs'>
                ...
                <ul className='mt-1 space-y-0.5 text-xs text-muted-foreground'>
                  <li>
                    -<code className='text-accent'>Content-Type</code>: text/html
                  </li>
                  <li>
                    -<code className='text-accent'>X-Custom-Header</code>: value
                  </li>
                  <li>
                    -<code className='text-accent'>Cache-Control</code>: no-cache
                  </li>
                </ul>
              </TooltipContent>
            </Tooltip>
      ...
      <FormDescription>Optional HTTP headers returned with the response</FormDescription>
    </FormItem>
  );
}
